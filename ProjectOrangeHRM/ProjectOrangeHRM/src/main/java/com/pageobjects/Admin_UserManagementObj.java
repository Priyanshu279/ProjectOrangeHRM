...
public class Admin_UserManagementObj {
	...
	@FindBy(xpath = "//*[@class='oxd-grid-2 orangehrm-full-width-grid']/div[4]/div[1]/div[2]/div[1]/div[1]") 
	...
	@FindBy(xpath ="//div[@class='orangehrm-container']/div/div/div/div/div/div[2]/div/div/div[2]")
